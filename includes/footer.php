<!--<article class="footer-info-col" data-section-type="newsletterSubscription">
    <div class="container">
        <h5 class="footer-info-heading">Sign up to Newsletter</h5>
        <p>...and receive <span><i class="fa fa-rupee"></i>100 coupon for first shopping.</span></p>
            ...
            <div class="row">
                <div class="col-md-5 col-sm-4">
                    <div class="footer-about mb-30">
                        ...
                        <img src="<?= BASEURL ?>img/logo/logo.png" alt="" />
                        <p>Bizaad.com is a Single window solution for all your requirements. The way of booking for
                            Outstation &amp; full day local Cabs, Hire Professional services, Repair &amp; Maintenance Service.
                            Bizaad is a online booking system to connect Customer, Supplier &amp; Professional at single
                            platform. We are providing various options to our customer to choose their requirement under
                            budget. Genuine Rating &amp; Review will help to select right options. We assure for great
                            experience &amp; satisfaction. Bizaad.com is promoted &amp; operated by Techwow Systems Pvt. Ltd.</p>
                ...
                <div class="col-md-2 col-sm-4">
                    <div class="footer-about mb-30">
                        <h4 class="footer-text">General</h4>
                        <ul class="content" >
                            <li><a href="./">Home</a></li>
                            <li><a href="<?= BASEURL ?>about.php">About Us</a></li>
                            <li><a href="<?= BASEURL ?>contact-us.php">Contact Us</a></li>
                            <li><a href="<?= BASEURL ?>cancellation.php">Cancellation</a></li>
                            <li><a href="<?= BASEURL ?>terms.php">Terms & Conditions</a></li>
                            <li><a href="<?= BASEURL ?>privacy.php">Privacy Policy</a></li>
                            <li><a href="<?= BASEURL ?>disclaimer.php">Disclaimer</a></li>
                ...
                <div class="col-md-2 hidden-sm">
                    <div class="footer-about mb-30">
                        ...
                        <ul class="content" >
                            <li><a href="<?= BASEURL ?>cab-book.php">Taxi & Tour</a></li>
                            <li><a href="<?= BASEURL ?>astrology/allUc1lSdm40OTlPR0dSMEV1V1RNZz09">Astrology Solutions</a></li>
                            <li><a href="<?= BASEURL ?>gemstone/Mi9CL25naEEvNi9rYWZnaldBZWlJQT09">Gemstones</a></li>
                            <li><a href="<?= BASEURL ?>professional-services/accounts-audit-return/WWhpYStXOGtBMEE1VUVqS1NJZTVxQT09">Repair & Maintenance</a></li>
                            <li><a href="<?= BASEURL ?>beauty-style/dTYyMkZKWmJkMll2UlArRGNGWTNYQT09">Beauty & Style</a></li>
                            <li><a href="<?= BASEURL ?>vendor-signup.php">Join Bizaad</a></li>
                            <li><a href="<?= BASEURL ?>Panel/Loginvendor">Vendor Sign in</a></li>
                ...
                <div class="col-md-3 col-sm-4">
                    <div class="footer-about mb-30">
                        <h4 class="footer-text">Contact Info</h4>
                        <ul class="footer-content" >
                            <li class="address">Address : 2162 / T14, Patel Road, Patel Nagar
                                New Delhi - 110008</li>
                            <li class="phone"><a href="tel:+91 999-993-4211">Phone: +91 999-993-4211</a></li>

                            <li class="Email"><a href="mailto:support@bizaad.com">Email: support@bizaad.com</a></li>
                        </ul>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <div class="copyright">
                        <p>Copyright &copy; 2019 <a target="_blank" href="#">Bizaad</a> All Right Reserved.</p>
                    </div>
                </div>
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <div class="footer-img floatright">
                        <img src="<?= BASEURL ?>img/footer/1.png" alt="" />
                    </div>
                </div>
            </div>
        </div>
...
<?php
if (!isset($_SESSION["city_session"]) || $_SESSION["city_session"] == '') {
    ?>
    <!--            <div class="first-popup">
                    <div class="first-popup-in">
                        <div class="inner-block">
                            <div class="head-text">
                                <h3>Select Your City</h3>
                            </div>
                            <form action="setcity.php" method="POST">
                                <div class="select-city">
                                    <i class="fa fa-3x fa-map-marker red-text" aria-hidden="true"></i>
                                    <p>Select Your City</p>
                                    <select id="location" name="location" class="select-location">
...
<script src="<?= BASEURL ?>js/addToCart.js" type="text/javascript"></script>
...
<script src="<?= BASEURL ?>js/additionalValidation.js" type="text/javascript"></script>
...
<script type="text/javascript">
    ...
    }, "Only Alphanumeric character accepted");
