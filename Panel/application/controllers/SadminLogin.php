...
EOD;
	...
	if ($this->role == 1) {
	    ...
	    $subject = "Login Credentials For bizaad.com " . date("Y-m-d H:i");
	    ...
	    $message .= "<br><p>You need to enter these credentials on following page :(https://www.bizaad.com/Loginvendor)</p>";
		...
		$this->email->reply_to('zeya7270@gmail.com', 'Vendors');
		$this->email->from('zeya7270@gmail.com', 'Bizaad');
