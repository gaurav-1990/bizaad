<main class="main-container">
    ...
    <div  class="panel panel-white">
        <div  class="panel-body  pb">
            <div class="card">
                <div class="card-body">
                    <?= form_open('SadminLogin/addAttr') ?>
                    <div class="row">
                        <div class=" col-sm-3">
                            <label for="">Prop. Name</label>
                            <select name="prop_id" class="form-control" id="prop_id">
            ...
            <table class="table table-bordered table-striped table-nowrap no-mb">
                ...
                <tbody>
                    ...
                    foreach ($attr as $at) {
                        ?>
                        <tr>
                           <td><a href="<?= site_url('SadminLogin/deleteAttr/') ?><?= $this->encrypt->encode($at->attr_id) ?>" class="btn btn-danger btn-xs"> <i class="fa fa-trash"></i> Delete</a></td>
                           <td><?=$at->pop_name?></td>
                           <td><?=$at->attr_name?></td>
