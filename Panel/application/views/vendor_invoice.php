    ...
    <body  style="font-family: Roboto, 'Segoe UI', Tahoma, sans-serif;font-size: 14px;">
        ...
        <table  style="margin:0 auto; "> 
            ...
            <tr>
                ...
                <td colspan="8" style="text-align: right;padding-right: 8px;"> <span style="border: 1px dashed #777;padding: 3px;">Invoice Number: VSHP/ <?= date("Y", strtotime($data->inv_date)) ?> /001</span> </td>
            </tr>
            ...
            <tr>
                <td colspan="11"> <img src="https://www.shoptrendy.in/bootstrap/images/shp.png" width="200"></td>
            ...
            <tr>
                <td colspan="11" style="border-bottom: 1px dashed #777">  
                    CIN N0: U51909DL2018PTC341611 | Contact Shoptrendy +91 966-727-4442 || vendors@shoptrendy.in  
