<main class="main-container">
    ...
    <h4>Search the Records Datewise:</h4><br>
    <div class="container">
        <?php echo form_open('Vendor/report_datewise')?>
        
            <div class="row">
                <div class="form-group col-md-3">
                    <label>FROM</label>
                    <?php echo form_input(['class'=>'form-control','name'=>'from','id'=>'tripstartdate','value'=>set_value('from')]);?>
            ...
            <div class="row">
                <div class="form-group col-md-2">
                    <?php echo form_submit(['class'=>'btn btn-success','value'=>'Submit', 'name'=>'submit']);?>
