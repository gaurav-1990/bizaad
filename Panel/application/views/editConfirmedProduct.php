<main class="main-container">
    ...
    <div  class="panel panel-white">
        <?= form_open_multipart('Vendor/updateConfirmedVendorRequest/', array('class' => 'form-horizontal', 'autocomplete' => 'off', 'id' => 'sform3', 'method' => 'POST')); ?>
        ...
        <div  class="panel-body  pb">
            <div class="row">
                <div class="col-sm-4">
                    <button type="submit"  class="btn btn-success"> <i class="fa fa-plus-circle"></i> Update</button>
                </div>
            </div>
        </div>
