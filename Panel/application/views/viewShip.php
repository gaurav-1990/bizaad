                                ...
                                <table class="table table-bordered table-striped table-nowrap no-mb" id="example">
                                    ...
                                    <tbody style="white-space: nowrap; overflow-x: scroll;">
                                        ...
                                        foreach ($ship as $details) {
                                            ?>
                                            <tr>
                                                <td><a onclick="return confirm('Want to delete this city')" href="<?= base_url('Vendor/deleteShip/') ?><?= $this->encrypt->encode($details->id) ?>" class="btn btn-xs btn-danger"> Delete</a></td>
                                                <td><?= $details->state ?></td>
                                                <td><?= $details->city ?></td>
                                                <td><?= $details->max_days ?></td>
                                                <td><?= $details->ship_amt ?></td>
                                                <td><?= $details->same_amt ?></td>
                                                <td><a href="<?= base_url('Vendor/checkPin/') ?><?= $this->encrypt->encode($details->id) ?>" class="btn btn-xs btn-success"> Check</a></td>
                                            </tr>
                                            <?php
                                        }
                                        ?>
