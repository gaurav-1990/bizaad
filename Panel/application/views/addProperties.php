<main class="main-container">
    ...
    <div  class="panel panel-white">
        <div  class="panel-body  pb">
            <div class="card">
                <div class="card-body">
                    <?= form_open('SadminLogin/addProperty') ?>
                    <div class="row">
                        <div class=" col-sm-3">
            ...
            <table class="table table-bordered table-striped table-nowrap no-mb">
                ...
                <tbody>
                    ...
                    foreach ($allProp as $prop) {
                        ?>
                        <tr>
                            <td><a href="<?= site_url('SadminLogin/deleteProp/') ?><?= $this->encrypt->encode($prop->propId) ?>" class="btn btn-danger btn-xs"> <i class="fa fa-trash"></i> Delete</a></td>
                            <td><?= $prop->pop_name ?></td>
                            <td><?= $prop->cat_name ?></td>
                            <td><?= $prop->sub_name ?></td>
