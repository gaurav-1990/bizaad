...
<main class="main-container">
    ...
    <div  class="panel panel-white">
        <?= form_open_multipart('Vendor/uploadImages', array('class' => 'form-horizontal', 'autocomplete' => 'off', 'id' => 'sform2', 'method' => 'POST')); ?>
        ...
        <div  class="panel-body  pb">
            <div class="row">
                <div class="col-sm-3">
                    ...
                    <input type="hidden" name="pro"  value="<?= $this->encrypt->encode($prod_id) ?>" />
                </div>
