                    ...
                    <div class="panel  panel-white">
                        <div class="panel-body">
                            ...
                            <div class="table-responsive">
                                ...
                                <?php if ($prodata->pro_sta == 1) { ?>
                                    <?= form_open("SadminLogin/updatePropAttrName") ?>
                                    <table class="table table-bordered table-striped table-nowrap no-mb">
                                        ...
                                        <tbody>
                                            ...
                                            <?php foreach ($propertiese->response as $keys => $response) { ?>
                                                <tr>
                                                    <td>
                                                        <?php
                                    ...
                                    <?= form_close(); ?>
                                <?php } else { ?>
                                    <form action="<?= base_url("SadminLogin/updatePropAttr") ?>" method="POST">
                                        <table class="table table-bordered table-striped table-nowrap no-mb">
                                            ...
                                            <input  type="hidden" name="proid" value="<?= $proid ?>"> 
                                            <input type="hidden" id='category' value="<?= $this->encrypt->encode($prodata->cat_id) ?>" />   
                                            <input type="hidden" id='subcategory' value="<?= $this->encrypt->encode($prodata->sub_id) ?>" /> 
                                            <div class="col-md-12">      
                                                <label for=""></label><br>
