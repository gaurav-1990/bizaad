...
<main class="main-container" style="background: #e0e0e0;height: 100%;">
    ...
    <div  class="panel panel-white demo-panel col-md-8">
        ...
        <div  class="panel-body pt-2x pb">
            ...
            <?= form_open('Loginvendor/submitLogin', array('class' => 'form-horizontal', 'autocomplete' => 'off', 'method' => 'POST')); ?>
            ...
            <?= form_close(); ?>
            <center>
                <a href="<?= site_url('Loginvendor/forgot')?>">Forgot Password ?</a>
            </center>
            <!-- /Form -->

        </div>
    </div>
    <div class="col-md-4">    <center> <img style="     
                                            margin: 0 auto;
                                            margin-bottom: 20px;" src="<?= base_url('bootstrap/images/shp.png') ?>"/></center></div>
</main>