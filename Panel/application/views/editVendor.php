...
<main class="main-container">
    ...
    <div  class="panel panel-white">
        <?= form_open_multipart('SadminLogin/updateVendor', array('class' => 'form-horizontal', 'autocomplete' => 'off', 'id' => 'sform2', 'method' => 'POST')); ?>
		...
		<div class="col-sm-6">
		    ...
		    <textarea name="aboutUs" cols="80" rows="3" autocomplete="off" required=""><?= ($vendor->aboutUs? $vendor->aboutUs:'') ?></textarea>
		</div>
                <?php if ($this->session->userdata('signupSession')['role'] == 1) { ?>
                    <div class="col-sm-3">
                ...
                <?php } ?>
                <input type="hidden" name="hidden_id"  id="hidden_id" value="<?= $this->encrypt->encode($vendor->id) ?>" />
            </div>
        </div>
        <div  class="panel-body  pb">
            <div class="row">
        ...
        <div  class="panel-body  pb">
            <div class="row">
                <div class="col-sm-3">
                    ...
                    <input type="text" id="bankname"  required=""   value="<?= ($vendor->bankname) ?>" name="bankname" class="form-control" placeholder="Bank Name">
                </div>
                <div class="col-sm-3">
                    <label>Bank Address</label>
                    <input type="text" id="bankadd"  required=""  value="<?= ($vendor->bankadd) ?>" name="bankadd" class="form-control" placeholder="Bank Adress">
                </div>
                <div class="col-sm-3">
                    <label>Holder Name</label>
                    <input type="text" id="holdername" required="" value="<?= ($vendor->holdername) ?>" name="holdername" class="form-control" placeholder="Holder Name">
                </div>
                <div class="col-sm-3">
                    <label>Account Number</label>
                    <input type="text" id="accountnum" required=""  value="<?= ($vendor->accountnum) ?>" name="accountnum" class="form-control" placeholder="Account Number">
                </div>
        ...
        <div  class="panel-body  pb">
            <div class="row">
                <div class="col-sm-3">
                    <label>IFSC</label>
                    <input type="text" id="ifsc" required="" value="<?= ($vendor->ifsc) ?>" name="ifsc" class="form-control" placeholder="IFSC">
                </div>
                <div class="col-sm-3">
                    <label>Owner Address</label>
                    <textarea   id="address" name="address"  class="form-control" placeholder="Address"><?= ($vendor->address) ?></textarea>
                </div>
                <div class="col-sm-3">
        ...
        <div  class="panel-body  pb">
            <div class="row">
                <div class="col-sm-3">
                    <label>GST no.</label>
                    <input type="text" id="gst_no"  name="gst_no" value="<?= $vendor->gst ?>"  class="form-control" placeholder="GST No."   value="" autocomplete="off" /> 
                </div>
        ...
        <div  class="panel-body  pb">
            <div class="row">
                ...
                <div class="col-sm-2 col-md-3">
                    ...
                    <input type="file" id="signature" name="signature"   class="form-control"    value="" autocomplete="off" /> 
                </div>
                <div class="col-sm-2 col-md-3">
                    <label>Upload Cancel Cheque</label>
                    <input type="file" id="can_cheque" name="can_cheque"  class="form-control"   value="" autocomplete="off" /> 
                </div>
            </div>
        </div>
