...
<main class="main-container">
    ...
    <div  class="panel panel-white demo-panel col-md-8">
        ...
        <div  class="panel-body pt-2x pb">
            ...
            <?= form_open('Loginvendor/forgotstep/'.$this->uri->segment(4), array('class' => 'form-horizontal', 'autocomplete' => 'off', 'method' => 'POST')); ?>
            <?= validation_errors();?>
            <div class="col-sm-12">
                ...
                <input type="hidden" value="<?= $this->encrypt->encode($user->id);?>" name="hid" />
                <div class="form-group">
                    <div class="col-sm-10">
...
<div class="col-md-4"> <center> <img style="margin: 0 auto; margin-bottom: 20px;" src="<?= base_url('bootstrap/images/shp.png') ?>"/></center></div>
</main>